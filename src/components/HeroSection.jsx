  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
        ...
        <div className=" pt-10 text-lg sm:text-xl lg:text-2xl bg-gradient-to-r from-blue-500 to-blue-800 text-transparent bg-clip-text">
          {" "}
          Providing a Premier Experince
        </div>
      </h1>
